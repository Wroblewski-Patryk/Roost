...
Generated at: 2026-05-25T01:13:55.082Z
...
| `docs/architecture/nodes/api_routes.csv` | yes | 177 | 26 |
...
| `docs/architecture/nodes/database_models.csv` | yes | 63 | 26 |
| `docs/architecture/nodes/migrations.csv` | yes | 30 | 26 |
...
| `docs/architecture/relations/dependencies.csv` | yes | 758 | 10 |
| `docs/architecture/chains/chains.csv` | yes | 34 | 15 |
| `docs/testing/test-map.csv` | yes | 8 | 13 |
| `docs/status/evidence-status.csv` | yes | 448 | 11 |
