...
- Override input: `C:/Personal/Projekty/Aplikacje/Roost/docs/architecture/scanner-overrides.json` (entity entries: 241, relation entries: 263).
- Override summary: excluded files 0, entity overrides 233, relation overrides 229, critical entities tagged 0.
