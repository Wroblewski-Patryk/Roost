...
- medium: Unclassified user workflow: USE /goals has app-completion risk missing_doc_link.
...
| --- | --- | --- | --- | --- |
| medium | app_completion_gap | Unclassified user workflow | Unclassified user workflow: USE /goals has app-completion risk missing_doc_link. | Docs Memory Lead + Project Manager |
