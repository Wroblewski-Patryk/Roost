...
Generated: 2026-07-15T17:10:29.646Z
Project: Roost
...
| appCompletionGaps | 26 |
| indexedAppCompletionGaps | 26 |
| knownAppCompletionRiskItems | 26 |
| appCompletionPriorityReviewItems | 26 |
...
- medium: Unclassified user workflow: USE /events has app-completion risk missing_doc_link.
...
| --- | --- | --- | --- | --- |
| medium | app_completion_gap | Unclassified user workflow | Unclassified user workflow: USE /events has app-completion risk missing_doc_link. | Docs Memory Lead + Project Manager |
