...
Generated: 2026-07-15T01:06:51.062Z
Project: Roost
...
- medium: Unclassified user workflow: USE /deals has app-completion risk missing_doc_link.
...
| --- | --- | --- | --- | --- |
| medium | app_completion_gap | Unclassified user workflow | Unclassified user workflow: USE /deals has app-completion risk missing_doc_link. | Docs Memory Lead + Project Manager |
