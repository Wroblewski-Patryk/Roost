...
Generated: 2026-07-15T03:39:29.555Z
Project: Roost
...
- Blocked: 0
- Known non-ok risk items: 27
- Priority review items indexed: 27/27
- Priority review truncated: false

## Flow Summary

- Unclassified user workflow: 36 entities; risks {"ok":11,"missing_doc_link":1,"missing_test_link":24}; gates {"auth":9}
...
| --- | --- | --- | --- | --- | --- | --- |
| Unclassified user workflow | missing_doc_link | api_endpoint | USE /departments | Engineering Delivery Lead | src/app.ts#/departments | auth |
