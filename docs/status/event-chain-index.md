...
| --- | --- | ---: | ---: | ---: | --- | --- |
| Account access | chain_indexed | 30 | 109 | 176 | - | Project Manager |
| Dashboard overview | chain_indexed | 15 | 39 | 40 | - | Project Manager |
| Exchange connection and configuration | chain_indexed | 2 | 5 | 52 | - | Project Manager |
...
| Unclassified user workflow | chain_indexed | 85 | 566 | 877 | - | Project Manager |
