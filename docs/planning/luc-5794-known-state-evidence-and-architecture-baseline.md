# LUC-5794 Known-State Evidence And Architecture Baseline
...
| --- | --- | --- |
| Architecture-awareness refresh | PASS | `node scripts/build-architecture-awareness-index.mjs --project Roost --root C:\Personal\Projekty\Aplikacje\Roost` from `C:\Personal\Projekty\Aplikacje\Paperclip_Softwarehouse` generated `2026-06-28T04:12:16.924Z` with `2560` entities, `5616` relations, `16129` files, `16` entity overrides and `3` relation overrides applied. |
| App-completion refresh | PASS | `node scripts/build-app-completion-index.mjs --project Roost --root C:\Personal\Projekty\Aplikacje\Roost` generated `2026-06-28T04:12:23.867Z` with `944` items, `7` flows, `913` missing test links, `0` missing doc links, `0` blocked, and `0` browser-review records. |
...
- `docs/status/architecture-ownership-report.md`: ownership split is
  `Engineering Delivery Lead=1343`, `Docs Memory Lead=1216`, and `Roost
  Project Manager=1`.
...
1. App-completion still exposes aggregate proof-link debt (`913` missing test
...
3. The current evidence baseline advanced generated artifacts by two
   ...
   [LUC-5787](/LUC/issues/LUC-5787). Risk: source-control and curation lanes
...
[LUC-5795](/LUC/issues/LUC-5795) is the linked source-control closure sidecar
