...
export const agentKeyProfiles = [
  ...
  {
    id: "mcp_procedure_author",
    label: "MCP Procedure Author",
    description: "Draft procedures and proposed procedure versions while reading application, task, process, knowledge, decision, and evidence context. Activation remains owner-controlled.",
    recommendedFor: ["Codex", "Documentation Agent", "Process Designer", "Human-supervised Author"],
    riskLevel: "medium",
    scopes: [
      ...mcpBaseScopes,
      "dashboard:read",
