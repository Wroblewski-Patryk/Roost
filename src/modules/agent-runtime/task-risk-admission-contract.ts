...
export const admissionOperations = ["runtime_execute", "review_decision", "return_to_executor", "create_specialist_task" , "handoff_create", "handoff_accept", "handoff_reject"] as const;
