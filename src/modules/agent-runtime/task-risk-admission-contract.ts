...
export const admissionOperations = ["runtime_execute", "review_decision", "return_to_executor", "create_specialist_task" , "handoff_create", "handoff_accept", "handoff_reject","clarification_send","clarification_reply", "interview_prepare", "decision_supersede"] as const;
