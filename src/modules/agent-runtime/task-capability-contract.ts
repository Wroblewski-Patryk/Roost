...
import { z } from "zod";
export const capabilityOperation = z.enum(["review_decision", "return_to_executor", "create_specialist_task", "handoff_create", "handoff_accept", "handoff_reject", "clarification_send", "clarification_reply", "interview_prepare"]);
