...
export function TaskReadinessModal({ taskId, onClose, onSaved }: { taskId: string; onClose: () => void; onSaved?: () => void }) {
  ...
  const reason = ["ready_pin_required", "context_changed", "context_invalid", "revalidation_required", "source_watch_required", "submission_required", "submission_incomplete", "single_task_scope_required"].includes(packet?.reason ?? "") ? packet!.reason! : "revalidation_required";
